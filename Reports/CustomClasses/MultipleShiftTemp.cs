...
{
    public class MultipleShiftTemp
    {
        private readonly MyDatabase _myDatabase;
        private readonly DataGridView _dataGridView;
        private readonly Label _label;

        public MultipleShiftTemp(DataGridView dataGridView, Label label)
        {
            ...
            switch (index)
            {
                ...
                case 1:
                    _myDatabase.getRecords("select t2.employeeid, t2.familiya, t2.ism, t2.otchestvo, t2.otdel," +
                        "t2.lavozim, t1.kirish, t1.chiqish, t1.temperature from reports t1 inner join employee t2 on " +
        ...
        private void GridHeaders(int index)
        {
            ...
            switch (index)
            {
                case 0:
                    ...
                    _dataGridView.Columns[16].HeaderText = "Температура";
                    _dataGridView.Columns[17].HeaderText = "Отсутствует";
                    break;
